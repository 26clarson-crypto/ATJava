/* Chloe Larson
Part C
Used the internet to help with generating random numbers how to use the various codes that were required in the assingment for the searching and timing
 */
...
public class PartC {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testCount; i++) {
            ...
            // Output results
            System.out.printf("Target Value: %d | Linear Search: %s (Time: %d ns) | Binary Search: %s (Time: %d ns)%n",
                    targetValue,
