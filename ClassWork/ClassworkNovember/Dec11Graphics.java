...
public class Dec11Graphics {
    ...
    public static void draw(Graphics g) { // retunrs nothing (void) calling a graphics object
        ...
        g.fillRect(0, 0, 100, 100); // change dimensions of square
        drawCircle(g);
    ...
    public static void drawCircle(Graphics g) {
        ...
        g.fillOval(99, 99, 100, 100); // draws a circle with center at (99,99) and diameter 100
    }
